...
BOT_TOKEN = getenv("8590882331:AAF8qXcYxMth8MpEIw-Zder_HBs_WAgsQWo")
OWNER_USERNAME = getenv("OWNER_USERNAME","cute_girl_rohini")
BOT_USERNAME = getenv("BOT_USERNAME" , "Strangerr_musicbot")
...
API_KEY = getenv("API_KEY", 'AIzaSyBg373pBpm8UdIi9XPQoilfqjOAEwmAVrU') # youtube song api key, generate free key or buy paid plan from panel.thequickearn.xyz


PRIVACY_LINK = getenv("PRIVACY_LINK", "https://telegra.ph/Privacy-Policy-for-YukkiMusic-08-30")
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+9crnpY_arOliZDRl")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+UVmAsDcR9u5kYzdl")
